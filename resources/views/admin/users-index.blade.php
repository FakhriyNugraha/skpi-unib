                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 whitespace-nowrap text-center text-xs font-medium space-x-2">
                                ...
                                <button type="button"
                                        ...
                                        onclick="window.dispatchEvent(new CustomEvent('open-generic-confirmation', {
                                            detail: {
                                                ...
                                                content: 'Apakah Anda yakin ingin menghapus mahasiswa <strong>{{ $user->name }}</strong>?<br>Aksi ini tidak dapat dibatalkan.',
                                                actionType: 'delete',
                                ...
                                <form id="delete-form-{{ $user->id }}" action="{{ route('admin.users-jurusan.destroy', $user) }}" method="POST" class="hidden">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </td>
