        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-gray-600 mt-2">Perbarui informasi mahasiswa - {{ $user->name }}</p>
                </div>
        ...
        <form id="user-edit-form" action="{{ route('admin.users-jurusan.update', $user) }}" method="POST">
            ...
            <div class="card p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    ...
                    <div>
                        ...
                        <textarea name="address" id="address" rows="3"
                                  ...
                                  placeholder="Alamat lengkap mahasiswa">{{ old('address', $user->address) }}</textarea>
                        @error('address')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex justify-end space-x-3">
                    <a href="{{ route('admin.users-jurusan.index') }}" class="px-4 py-2 rounded-lg bg-red-600 text-white hover:bg-red-700 shadow-sm inline-flex items-center justify-center transition duration-300 ease-out hover:scale-105 hover:-translate-y-0.5 hover:shadow-lg">
