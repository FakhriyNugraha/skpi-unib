            ...
            <div class="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
                ...
                <div class="text-sm text-gray-500 flex items-center gap-4">
                    @if(request('status') === 'approved' || empty(request('status')))
                        <a href="{{ route('superadmin.print-bulk-form') }}" class="btn bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white focus:ring-purple-300 px-4 py-2 text-sm font-medium transition-all duration-200 flex items-center shadow-lg hover:shadow-xl rounded-lg gap-2">
