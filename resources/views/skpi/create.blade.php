    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form id="skpiForm" method="POST"
            ...
            <div class="card p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label for="nomor_ijazah" class="block text-sm font-medium text-gray-700 mb-2">Nomor Ijazah <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label for="tanggal_lulus" class="block text-sm font-medium text-gray-700 mb-2">Tanggal Lulus <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label for="gelar" class="block text-sm font-medium text-gray-700 mb-2">Gelar <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label for="program_studi" class="block text-sm font-medium text-gray-700 mb-2">Program Studi <span class="text-red-500">*</span></label>
                ...
                <div class="mt-4 text-sm text-blue-600 bg-blue-50 p-3 rounded-lg border border-blue-200">
                <p><span class="font-semibold">Catatan:</span> Kolom yang bertanda <span class="text-red-500 font-bold">*</span> wajib diisi.</p>
            </div>
            </div>
            ...
            <div class="card p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <!-- Petunjuk pengisian keseluruhan untuk prestasi dan aktivitas -->
                    <div class="md:col-span-2 mt-0 p-5 bg-blue-50 border-l-4 border-blue-400 rounded-lg shadow-sm">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3">
                                ...
                                <div class="mt-2 text-sm text-blue-700">
                                    <p class="mb-0"><span class="font-semibold">Jika tidak memiliki</span> sertifikat kompetensi/prestasi akademik/prestasi non-akademik/pengalaman organisasi/pengalaman kerja, atau catatan khusus, silakan isi dengan tanda <span class="font-mono font-bold">"-".</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2 flex flex-col">
                        ...
                        <!-- Petunjuk (didesain agar lebih menonjol dan informatif) -->
                        <div class="mt-4 p-5 bg-yellow-50 border-l-4 border-yellow-400 rounded-lg shadow-sm">
                            <div class="flex items-start">
                                <div class="flex-shrink-0">
                                ...
                                <div class="ml-3">
                                    ...
                                    <div class="mt-2 text-sm text-yellow-700">
                                        ...
                                        <ul class="list-disc pl-5 space-y-1">
                                            ...
                                            <li class="font-medium"><span class="text-gray-700">Prestasi Non-Akademik</span> - Dokumen bukti prestasi non-akademik (olahraga, seni, organisasi, dll)</li>
                                            <li class="font-medium"><span class="text-gray-700">Pengalaman Kerja/Magang</span> - Dokumen bukti pengalaman kerja atau magang</li>
                                            <li class="font-medium"><span class="text-gray-700">Sertifikat Kompetensi</span> - Sertifikat keahlian, pelatihan, dan kompetensi</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
