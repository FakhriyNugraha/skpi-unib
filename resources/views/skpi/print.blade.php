...
<body>
    ...
    <div class="container">
            ...
            <div class="item">
                <div class="two-column">
                    <div class="column">
                        ...
                        <span class="item-value">Informatika</span>
                    </div>
                    <div class="column">
                        <span class="item-italic">Study Program</span><br>
                        <span class="item-value">Informatics</span>
                    </div>
                </div>
            </div>
        ...
        <div class="section page-break">
            ...
            <!-- Tanda Tangan -->
            <div class="signature">
                <p>Bengkulu, {{ \Carbon\Carbon::now()->locale('id')->isoFormat('D MMMM YYYY') }}</p>
        ...
        <div class="footer">
            ...
            <p>Tanggal Cetak: 14 November 2023 10:30 WIB</p>
        </div>
    </div>
</body>
</html>
